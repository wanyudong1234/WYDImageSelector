...
- (UIButton *) setupButtonWithImageName : (NSString *) imageName andX : (CGFloat ) x{
    ...
    [button setImage:[UIImage imageNamed:imageName inBundle:[NSBundle mainBundle] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
...
//    [closeBtn addTarget:self action:@selector(closeFlashlight:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [cameraBtn setImage:[UIImage imageNamed:@"paizhao.png" inBundle:[NSBundle mainBundle] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
