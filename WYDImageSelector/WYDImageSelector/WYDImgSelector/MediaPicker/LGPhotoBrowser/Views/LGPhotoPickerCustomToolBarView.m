...
- (void)updateToolbarWithOriginal:(BOOL)isOriginal
    ...
    if (isOriginal) {
        ...
        self.isOriginalBtn = [self createSelecteOriginalItemWithImg:[UIImage imageNamed:@"btn_original.png" inBundle:[NSBundle mainBundle] compatibleWithTraitCollection:nil]
                                       title:[NSString stringWithFormat:@"原图%@",self.fileSize]
                                  titleColor:[UIColor whiteColor]
                                      target:self
                                      action:@selector(originalAction)];
    } else {
        self.isOriginalBtn = [self createSelecteOriginalItemWithImg:[UIImage imageNamed:@"btn_original_non.png" inBundle:[NSBundle mainBundle] compatibleWithTraitCollection:nil]
                                       title:@"原图"
