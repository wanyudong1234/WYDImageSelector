...
- (UIImageView *)tickImageView {
    if (!_tickImageView) {
        ...
        tickImageView.image = [UIImage imageNamed:@"checkbox_pic_non" inBundle:[NSBundle mainBundle] compatibleWithTraitCollection:nil];
...
- (void)setMaskViewFlag:(BOOL)maskViewFlag {
    ...
    if (!maskViewFlag) {
        // hidden
        [self.tickImageView setImage:[UIImage imageNamed:@"checkbox_pic_non" inBundle:[NSBundle mainBundle] compatibleWithTraitCollection:nil]];
    }else{
        [self.tickImageView setImage:[UIImage imageNamed:@"checkbox_pic" inBundle:[NSBundle mainBundle] compatibleWithTraitCollection:nil]];
    }
